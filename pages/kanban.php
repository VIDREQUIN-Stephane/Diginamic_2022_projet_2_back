        ...
        <nav class="col-md-2 d-md-block bg-light sidebar py-5 ">
            <div class="sidebar-sticky ps-1">
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=categ">
                ...
                <div class="col-12 col-lg-6 col-xl-3">
                    <div class="card card-border-primary">
                        <div class="card-header">
                            <h5 class="card-title"><?= $row['nom_categorie'] ?></h5>
                        ...
                        <div class="card-body p-3">
                            ...
                            <a href="index.php?page=form_add_task" class="btn btn-primary btn-block">Add new</a>
